...
$possible_plugin_locations = array(
	...
	'D:\code\xampp2.0\htdocs\Personal Website\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/Personal%20Website/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'D:\code\xampp2.0\htdocs\Personal Website\wp-content\plugins\wp-optimize\cache/extensions');
}
